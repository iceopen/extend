 ...
 */
defined('LOG_PATH') or define('LOG_PATH', dirname(__FILE__) . '/');
defined('LOG_RECORD') or define('LOG_RECORD', false);
defined('LOG_TYPE') or define('LOG_TYPE', 3);
defined('LOG_DEST') or define('LOG_DEST', '');
defined('LOG_EXTRA') or define('LOG_EXTRA', '');
defined('LOG_LEVEL') or define('LOG_LEVEL', 'EMERG,ALERT,CRIT,ERR');
defined('LOG_FILE_SIZE') or define('LOG_FILE_SIZE', 2097152);
defined('LOG_EXCEPTION_RECORD') or define('LOG_EXCEPTION_RECORD', false);
class Log
{
